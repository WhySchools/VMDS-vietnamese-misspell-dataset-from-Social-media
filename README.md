...
1. Trích dẫn, lấy một phần dữ liệu hoặc lấy hoàn toàn dữ liệu từ các bình luận, trao đổi trên các mạng xã hội thông dụng tại Việt Nam, tuy nhiên các thông tin liên quan đến thông tin cá nhân của những người có liên quan đến nội dung sẽ được loại bỏ hoặc xử lý. Ví dụ: _chú X gặp chú Y_, _anh X có đi làm không_,... Các trường hợp để tên riêng: Các nhân vật công chúng, nhân vật lịch sử, nhân vật hư cấu tiểu thuyết, tên thương hiệu đã được đi vào ngôn ngữ đại chúng (ví dụ google, zipper,...),....
...
HiImsoLazy (1656 cases), Huy Phước (7 cases)
## Trích dẫn
### APA
```
